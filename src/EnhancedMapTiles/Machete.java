...
public class Machete extends EnhancedMapTile {
    public Machete(Point location) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("machete.png"), 16, 16), TileType.NOT_PASSABLE);
    }
